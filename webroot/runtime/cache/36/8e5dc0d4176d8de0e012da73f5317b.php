...
//000000003600
 exit();?>
s:7808:"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>三傻大闹宝莱乌搜索结果 - 好快影视网</title>
<meta name="keywords" content="三傻大闹宝莱乌搜索结果" />
<meta name="description" content="三傻大闹宝莱乌搜索结果" />
...
<div class="container">
				...
				<div class="stui-pannel-box">
					<div class="stui-pannel_hd">
						<div class="stui-pannel__head active bottom-line clearfix">
							...
							<h3 class="title">
								<img src="/template/helen_ten/images/icon_27.png" />与"三傻大闹宝莱乌"相关的影片</h3></div>
					</div>
					<div class="stui-pannel_bd">
						<ul class="stui-vodlist__media col-pd clearfix">						</ul>
					</div>
				</div>
			</div>
			<!-- 搜索列表 -->
    ...
    <h1>没有找到匹配数据</h1>
		...
		<script>$('.mac_total').html('0');</script>
