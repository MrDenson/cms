        ...
        document.write('<style>.bofang_box{width:100%;height:280px;}</style>');
         ...
         document.write('<style>.bofang_box{width:100%;height:620px;}</style>');
                ...
                <div class="stui-player__detail detail">
                  ...
                  <h4 class="title">
                    <a href="/vod-detail-id-76524.html"><?php echo $obj['vod_name']; ?></a></h4>
                  ...
                  <div class="detail-content" style="display: none;">
                    ...
                    <p class="desc margin-0">
                      <span class="left text-muted">简介：</span><?php echo $obj['vod_blurb']; ?>…</p></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="stui-pannel-box">
            ...
            <div class="stui-pannel_bd col-pd clearfix">
			  ...
			  <?php if(is_array($vo['urls']) || $vo['urls'] instanceof \think\Collection || $vo['urls'] instanceof \think\Paginator): if( count($vo['urls'])==0 ) : echo "" ;else: foreach($vo['urls'] as $key2=>$vo2): ?>
                <li><a title='<?php echo $vo2['name']; ?>' href='<?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>$vo2['nid']]); ?>'  <?php if($param['sid'] == $vo['sid'] && $param['nid'] == $vo2['nid']): ?>class="cur" <?php endif; ?> target="_self"><?php echo $vo2['name']; ?></a></li>
			  <?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
          </div>
