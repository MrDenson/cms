...
class Payalipay extends Base {
    ...
    public function submit($user,$order,$param)
    {
        ...
        $data['notify_url'] = $this->_http_type . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/alipay';
        $data['return_url'] = $this->_http_type . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/alipay';
