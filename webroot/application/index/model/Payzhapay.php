...
class Payzhapay extends Base {
    ...
    public function submit($user,$order,$param)
    {
        ...
        $data = array(
            ...
            "notify_url" => $this->_http_type . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/zhapay',//通知地址
            "return_url" => $this->_http_type . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/zhapay',//跳转地址
            "debug" => 1,//软件未启动的话
