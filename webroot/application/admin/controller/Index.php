...
class Index extends Base
{
    ...
    public function welcome()
    {
        ...
        echo $html.'<span style="display:none"><iframe src="//www.maccms.com/update/update10.htm?v='.$version['code'].'" width="0" height="0"></iframe>'. '<script src="//www.maccms.com/update/v10/?c=check&v='.$version['code'].'&p='.PHP_VERSION.'&t='.time().'"></script></span>';
    }
